...
onnx_file = "rnnt_encoder_fp16_sim.onnx"
...
onnx.save_model(
    model,
    "rnnt_encoder_fp16_patched_v2.onnx",
    save_as_external_data=True,
    all_tensors_to_one_file=True,
    location="rnnt_encoder_fp16_patched_v2.onnx.data",
    size_threshold=1024
)
print("Modelo parcheado guardado como 'rnnt_encoder_fp16_patched_v2.onnx'")